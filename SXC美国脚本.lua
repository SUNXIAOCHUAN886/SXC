...
local win1 = library:CreateTab("关于作者");

win1:NewButton("点击加载问题", function()
...
win1:NewButton("加载文件,必须点击", function()--演示
    game.Players.LocalPlayer:Kick("加载完成，你已被骗🤓，美国笑川是必须坑人的😎")
    print("btn3");
end)

local win1 = library:CreateTab("穷小子打工记传送");
...
local win1 = library:CreateTab("无功能纯摆设");
